...
if ($permission['editcateg']) {
    ...
    foreach ($category->catTree as $cat) {
        ...
        if (count($category->getChildren($cat['id'])) != 0) {
            ...
            printf("<p>%s<strong style=\"vertical-align: top;\">&middot; %s <a href=\"javascript:void(0);\" onclick=\"javascript:toggleFieldset('%d');\"><img src=\"../images/more.gif\" width=\"11\" height=\"11\" alt=\"\" /></a></strong> ",
                $indent,
                $catname,
                $cat['id']);
        } else {
